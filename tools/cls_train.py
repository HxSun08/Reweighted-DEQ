...
from utils.utils import imbalance_split
...
def main():
    ...
    if dataset_name == 'imagenet':
        ...
        train_dataset_imbalance, valid_dataset_imbalance = imbalance_split(train_dataset, valid_dataset, beta=config.DATASET.BETA)
       
    if config.DATASET.IMBALANCE:
        train_loader = torch.utils.data.DataLoader(
            train_dataset_imbalance,
