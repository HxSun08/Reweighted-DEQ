...
sys.path.append("../")
from utils.optimizations import VariationalHidDropout2d, weight_norm
from utils.solvers import anderson, broyden
from utils.jacobian import jac_loss_estimate, power_method
from utils.layer_utils import list2vec, vec2list, norm_diff, conv3x3, conv5x5
