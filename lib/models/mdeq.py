...
sys.path.append("../")
from utils.layer_utils import conv3x3
...
class MDEQClsNet(MDEQNet):
    ...
    def _make_head(self, pre_stage_channels):
        ...
        final_layer = nn.Sequential(nn.Conv2d(head_channels[len(pre_stage_channels)-1] * head_block.expansion,
                                    ...
                                    nn.ReLU(inplace=True))
        # final_layer = nn.Sequential(nn.Linear(64*16*16,64),
        #                             nn.Linear(64,200*16*16))
